...
class PeerGroupAfiSafiListReaderTest : AbstractNetconfHandlerTest() {
    ...
    fun testReadCurrentAttributes() {
        ...
        val configAfiSafinames = PeerGroupAfiSafiListReader.parseAfiSafis(instance, PeerGroupKey("PEERGR01"))
            .map { afiSafiKey -> afiSafiKey.afiSafiName }.toSet()
        Assert.assertTrue(configAfiSafinames.contains(afiSafiName))
    }
}