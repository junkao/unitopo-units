...
class InterfaceDampeningConfigWriter(private val underlayAccess: UnderlayAccess) : WriterCustomizer<Config> {
    ...
    override fun writeCurrentAttributes(
        ...
        require(InterfaceDampeningConfigReader.isSupportedInterface(ifcName)) {
