...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.ipv4.ospf.cfg.rev191031.`$YangModuleInfoImpl` as UnderlayOspfConfigYangModule
...
class Unit(private val registry: TranslationUnitCollector) : Unit() {
    ...
    override fun toString(): String = "Cisco-IOS-XR-ipv4-ospf-cfg@2019-10-31 OSPF translate unit"
}