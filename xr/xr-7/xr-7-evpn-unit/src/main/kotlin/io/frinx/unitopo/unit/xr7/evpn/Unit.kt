...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.l2vpn.cfg.rev190405.`$YangModuleInfoImpl` as UnderlayEvpnsYangInfo
...
class Unit(private val registry: TranslationUnitCollector) : Unit() {
    ...
    override fun toString(): String = "Translate unit Cisco-IOS-XR-l2vpn-cfg@2019-04-05"
