...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.bundlemgr.cfg.rev190512.`$YangModuleInfoImpl` as UnderlayBundleMgrYangInfo
...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.infra.statsd.cfg.rev190405.`$YangModuleInfoImpl` as UnderlayInfraStatsdInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.ipv4.io.cfg.rev190405.`$YangModuleInfoImpl` as UnderlayIpv4YangInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.l2.eth.infra.cfg.rev190405.`$YangModuleInfoImpl` as UnderlayInfraYangInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.l2.eth.infra.datatypes.rev190405.`$YangModuleInfoImpl` as UnderlayDatatypesYangInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.mdrv.lib.cfg.rev190405.`$YangModuleInfoImpl` as UnderlayMdrvLibYangInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.xr.types.rev190405.`$YangModuleInfoImpl` as UnderlayTypesYangInfo
...
class Unit(private val registry: TranslationUnitCollector) : Unit() {
    ...
    override fun toString(): String = "Translation unit of Cisco-IOS-XR-ifmgr-cfg@2019-04-05"
