...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.clns.isis.cfg.rev191031.`$YangModuleInfoImpl` as UnderlayIsisYangInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.clns.isis.datatypes.rev190405.`$YangModuleInfoImpl` as UnderlayIsisTypesYangInfo
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.infra.rsi.cfg.rev191031.`$YangModuleInfoImpl` as UnderlayVRFYangInto
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.`$YangModuleInfoImpl` as UnderlayQosMaCfgYangInfo
...
class Unit(private val registry: TranslationUnitCollector) : TranslateUnit {
    ...
    override fun toString(): String = "Translate unit of Cisco-IOS-XR-infra-rsi-cfg@2019-10-31"
}