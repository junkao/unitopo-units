...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.policy.repository.cfg.rev190405.routing.policy.route.policies.RoutePolicyBuilder
...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.xr.types.rev190405.RplPolicy
...
class PolicyDefinitionConfigWriter(private val underlayAccess: UnderlayAccess) : WriterCustomizer<Config> {
    ...
    private fun getData(id: IID<Config>, dataAfter: Config): Pair<IID<RoutePolicy>, RoutePolicy> {
        ...
        return Pair(underlayId, getUnderlayEmptyPolicy(policyName))
    }
    ...
    companion object {
        ...
        fun getUnderlayEmptyPolicy(policyName: String) = RoutePolicyBuilder()
            .setRoutePolicyName(CiscoIosXrString(policyName))
            .setRplRoutePolicy(RplPolicy("route-policy $policyName\nend-policy"))
            .build()
    }
}