...
class IngressAclSetConfigReaderTest {
    ...
    private lateinit var target: IngressAclSetConfigReader

    @Before
    fun setup() {
        MockitoAnnotations.initMocks(this)

        target = IngressAclSetConfigReader()
    }
    ...
    fun testMerge() {
        ...
        val parentBuilder = IngressAclSetBuilder()
    ...
    @Test
    fun testGetBuilder() {
        val result = target.getBuilder(IIDs.AC_IN_IN_IN_IN_CONFIG)
